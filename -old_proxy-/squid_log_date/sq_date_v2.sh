...
dt=`date -j -f "%d-%b-%Y-%T" "19-июня-2020-11:30:00" "+%d-%m-%Y-%T"`; dtb=`date -j -f "%d-%m-%Y-%T" $dt "+%s"`
#echo $dtb
#dt=`date -j -f "%d-%b-%Y-%T" "6-июня-2020-13:35:00" "+%d-%m-%Y-%T"`; dte=`date -j -f "%d-%m-%Y-%T" $dt "+%s"`
dt=`date -j -f "%d-%b-%Y-%T" "19-июня-2020-11:45:00" "+%d-%m-%Y-%T"`; dte=`date -j -f "%d-%m-%Y-%T" $dt "+%s"`
#echo $dte
